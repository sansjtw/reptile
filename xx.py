...
print("An Reptile: https://wwz.lanzoum.com/ihPyC0d00l0f\n密码:3oed")
now = datetime.datetime.now()
other_StyleTime = now.strftime("当前时间: %Y 年 %m 月 %d 号")
...
if ssl in ["17"]: 
    os.system('python use/18.py')
    now = datetime.datetime.now()
    other_StyleTime = now.strftime("%Y-%m-%d %H:%M:%S")
    Note=open("use/Reptile.txt",mode='a')
    Note.write('时间:['+other_StyleTime)
    Note.write(']---root用户关闭了工具17\n')
    Note.close()

if ssl in ["18"]: 
    os.system('python use/19.py')
    now = datetime.datetime.now()
    other_StyleTime = now.strftime("%Y-%m-%d %H:%M:%S")
    Note=open("use/Reptile.txt",mode='a')
    Note.write('时间:['+other_StyleTime)
    Note.write(']---root用户关闭了工具18\n')
    Note.close()

if ssl in ["19"]: 
    os.system('python use/20.py')
    now = datetime.datetime.now()
    other_StyleTime = now.strftime("%Y-%m-%d %H:%M:%S")
    Note=open("use/Reptile.txt",mode='a')
    Note.write('时间:['+other_StyleTime)
    Note.write(']---root用户关闭了工具19\n')
    Note.close()
    
if ssl in ["20"]: 
    os.system('python use/21.py')
    now = datetime.datetime.now()
    other_StyleTime = now.strftime("%Y-%m-%d %H:%M:%S")
    Note=open("use/Reptile.txt",mode='a')
    Note.write('时间:['+other_StyleTime)
    Note.write(']---root用户关闭了工具20\n')
    Note.close()
...
if ssl in ["sans"]:
    print("开始更新")
    os.system('cd')
    os.system('rm -frv reptile')
    os.system('git clone https://gitee.com/sansjtw/reptile')
    os.system('cd reptile')
