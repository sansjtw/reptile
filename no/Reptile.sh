...
echo ""
echo ""
echo "换国内源→更新源→下载git→下载python→下载python2→下载python3→安装Beautifulsoup4库→安装requests库→安装datetime库→安装wget库→安装npm→下载Reptile→进入Reptile文件夹→手动进入Reptile"
